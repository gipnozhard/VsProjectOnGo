Мини - приложение треминальное, перебирает расхождения построчное в двух файлах, если эти расхождения есть выводит в терминал,так же показывает сколько строк в файлах в каждом.
